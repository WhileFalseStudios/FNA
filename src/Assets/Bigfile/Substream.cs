...
{
    /// <summary>
    /// Substream implementation from:
    /// <para>https://social.msdn.microsoft.com/Forums/vstudio/en-US/c409b63b-37df-40ca-9322-458ffe06ea48/how-to-access-part-of-a-filestream-or-memorystream?forum=netfxbcl</para>
    /// </summary>
    class SubStream : Stream
    {
        ...
        /// <summary>
        /// NOTE: we MAY need to implement this if anything in FNA that is using our bigfile streams tries to use it and breaks things.
        /// </summary>
